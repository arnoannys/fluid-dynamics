...
// maakt alle plots uit het verslag
...
////////////////// DE GEDREVEN CAVITEIT /////////////////////////////////////////////////////////////////////////////
     ...
     {
      systeem sys(41 , 41 ,0.05, 0.05 );  //Re = 25
      sys.add_band(5);
      state statte( &sys ) ;
      statte.evolve(0.0005 ,25000, 0.2 , 0.5);
      plt.meshgrid(statte.get_matrix("p"));
      plt.pyplot(statte.get_matrix("p"));
      plt.pyplot(statte.get_matrix("u"));
      plt.pyplot(statte.get_matrix("v"));
     ...
     {
      systeem sys(41 , 41 ,0.05, 0.05 );  //Re = 50
      sys.add_band(10);
      state statte( &sys ) ;
      statte.evolve(0.0005 ,25000, .2 , .5);
      plt.meshgrid(statte.get_matrix("p"));
      plt.pyplot(statte.get_matrix("p"));
      plt.pyplot(statte.get_matrix("u"));
      plt.pyplot(statte.get_matrix("v"));
     ...
     {
      systeem sys(41 , 41 ,0.05, 0.05 );  //Re = 100
      sys.add_band(10);
      state statte( &sys ) ;
      statte.evolve(0.0005 ,25000, 0.1 , .5);
      plt.meshgrid(statte.get_matrix("p"));
      plt.pyplot(statte.get_matrix("p"));
      plt.pyplot(statte.get_matrix("u"));
      plt.pyplot(statte.get_matrix("v"));
...
////////////////// BUIS /////////////////////////////////////////////////////////////////////////////
   ...
   {
     systeem sys(41 , 41 ,0.05, 0.05 ); //in verg. met 1 hier gelijke reynolds , grotere F
     sys.add_cyclic();
     sys.add_ext_force(2.);
     state statte( &sys ) ;
     statte.evolve(0.001 ,25000, 0.4 , .1);
     plt.meshgrid(statte.get_matrix("p"));
     plt.pyplot(statte.get_matrix("p"));
     plt.pyplot(statte.get_matrix("u"));
     plt.pyplot(statte.get_matrix("v"));
    ...
    {
      systeem sys(41 , 41 ,0.05, 0.05 ); //in verg. met 2 hier groter reynolds , gelijke F
      sys.add_cyclic();
      sys.add_ext_force(2.);
      state statte( &sys ) ;
      statte.evolve(0.001 ,25000, 0.2 , .1);
      plt.meshgrid(statte.get_matrix("p"));
      plt.pyplot(statte.get_matrix("p"));
      plt.pyplot(statte.get_matrix("u"));
      plt.pyplot(statte.get_matrix("v"));
...
////////////////// BUIS met obstakel /////////////////////////////////////////////////////////////////////////////
  {
   ...
   {
        systeem sys(61 ,61 ,0.05, 0.05);
        sys.add_cyclic();
        sys.add_ext_force(5.);
        sys.add_blok(5,10);
        state statte( &sys ) ;
        statte.evolve(0.0001 ,50000, 0.1 ,1.2);
        plt.meshgrid(statte.get_matrix("p"));
        plt.pyplot(statte.get_matrix("p"));
        plt.pyplot(statte.get_matrix("u"));
        plt.pyplot(statte.get_matrix("v"));
