...
def plot_3():
	...
	p = np.where(p ==  0.000042 , np.nan , p) #dit was het getal dat was gekozen voor punten die niet mee deden, zie verslag voor een uitleg
	x = np.multiply(x,2./(len(x)-1)) #zet om naar 2 bij 2 ruimte	
